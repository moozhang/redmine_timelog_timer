...
See {COPYRIGHT.txt}[https://github.com/e-dot/redmine_timelog_timer/blob/master/COPYRIGHT.txt] and {GPL.txt}[https://github.com/e-dot/redmine_timelog_timer/blob/master/GPL.txt] for details.
